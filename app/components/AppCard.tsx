...
const AppCard: React.FC<AppCardProps> = ({
	...
	const renderIcon = () => {
		if (typeof icon === 'string') {
			return <Image src={icon} alt="icon" className="mr-2 w-6 h-6" width={24} height={24} />;
		}
		return icon;
	};
